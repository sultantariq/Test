...
{
  var link = "https://gist.githubusercontent.com/sultantariq/236602f70dbdd99b2b685651ad3f1e44/raw/f55411022ed5cd4ac9cc81d016d737ac03c8dea6/Stephanie_All_Months.csv";

if (val=='weekly')
{
  link="https://gist.githubusercontent.com/sultantariq/fff2359652a38023bfafa000b0c0b78d/raw/8a26a5accd83c2c113b67e08ea9256002049bf4b/Stephanie_All_Weeks.csv"
}

else if (val == 'monthly')
{
  link="https://gist.githubusercontent.com/sultantariq/236602f70dbdd99b2b685651ad3f1e44/raw/f55411022ed5cd4ac9cc81d016d737ac03c8dea6/Stephanie_All_Months.csv"
}

else if (val == 'yearly')
{
  link="https://gist.githubusercontent.com/sultantariq/18a7fa41d388dc3576c31fceb2514e51/raw/fb2ce7ee9b76646a29294ee1d386f1f4fb256470/Stephanie_All_Yearly.csv"
}
return link;
  ...
  if (selectIndex=="1stbonus")
    {
      ...
      var kpi=Math.round(getKPI(cellValuescopy,1,firstBonusMonths))
...
//get the Pause time
   pauseTimePerday= getKPI(cellValuescopy,8,firstBonusMonths)
...
document.getElementById("pauseTimePerdayValue").textContent=pauseTimePerdayValue;
 ...
 var kpi=Math.round(getKPI(cellValuescopy,1,secondBonusMonths))
 ...
 else 
 {
  ...
  document.getElementById("talkTimePerMinValue").textContent=talkTimePerMinValue;
  //get the Pause time
   pauseTimePerday= getKPI(cellValuescopy,8,secondBonusMonths)
 if (pauseTimePerday >1)
 {
  pauseTimePerdayValue=headerNames[8]+' : ' +pauseTimePerday + 'hours = ' + pauseTimePerday*60 +'mins'
 }
...
document.getElementById("pauseTimePerdayValue").textContent=pauseTimePerdayValue;
 ...
 var kpi=Math.round(getKPI(cellValuescopy,1,thirdBonusMonths))
 ...
 else 
 {
  ...
  document.getElementById("talkTimePerMinValue").textContent=talkTimePerMinValue;
  //get the Pause time
   pauseTimePerday= getKPI(cellValuescopy,8,thirdBonusMonths)
 if (pauseTimePerday >1)
 {
  pauseTimePerdayValue=headerNames[8]+' : ' +pauseTimePerday + 'hours = ' + pauseTimePerday*60 +'mins'
 }
